...
static const SignalType_t Meas3SigIdx2SignalType_Default[MEAS3_SYS_MAX][MEAS3_SIG_MAX] =
{
    ...
    /*   IRN */ {SIG_IRNL5,  SIG_IRNS1,  SIG_IRNL1,  SIG_LAST,   SIG_LAST,  SIG_LAST,  SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST, SIG_LAST}
};
