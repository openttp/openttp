...
The Open Time-Transfer Platform is an open source solution for providing traceable time and frequency.
...
%% ****************************************************************************************
\chapter{The reference platform}
%% ****************************************************************************************

\input{srcs/systemunit}
\input{srcs/frontpanel}
\input{srcs/counter}
