...
GPS ephemerides with URA greater than this will not be used. T
...
other processes (eg \cc{minicom}) opening a serial port while it is in use. The default is \cc{/var/lock}\\
\textit{Example:}
\begin{lstlisting}
# This is for Debian
