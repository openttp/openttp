...
As with other paths specified ib \cc{gpscv.conf}, it is interpreted as being relative to the user's
...
The output directory is usually defined in each CGGGTS output section.\\
\textit{Example:}
\begin{lstlisting}
CGGTTS=cggtts
\end{lstlisting}
