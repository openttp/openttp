...
\cc{runr2cggttsv8.py} is a script that can be used to automate the running of
\cc{rcggtts} a program commonly used for generating CGGTTS files from RINEX files.
