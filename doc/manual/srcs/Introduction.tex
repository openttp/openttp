...
The software currently supports several different GNSS receivers and counter/timers. 
...
the OpenTTP project.
	...
	\subsection{Supported counter/timers}
	
	Counter/timers supported by OpenTTP are listed in \ref{t:counters}.
	...
	TAPR & TICC &\\
	\end{tabular}
	\caption{Supported counter/timers. \label{t:counters}}
	\end{table}
